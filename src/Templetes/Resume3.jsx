    ...
    >
      <div
        style={{
          width: "100%",
          height: "18vh",
          backgroundColor: "rgba(22, 113, 173, 0.915)",
        }}
      >
        <h1
          className="name"
      ...
      <div
        style={{
          ...
          width: "35%",
          height: "90vh",
          backgroundColor: " rgba(226, 228, 230, 0.915)",
          padding: "5px 20px 5px 20px",
          border:"solid black 1px"
        }}
      >
        <div className="contact">
          <h1 style={{ color: "rgba(22, 113, 173, 0.915)", fontWeight: "bold" }}>
            CONTACT
          </h1>
          <hr />
          <p className="para">
      ...
      >
        <div className="objective">
          <h1 style={{ color: "white", background: "rgba(22, 113, 173, 0.915)", fontWeight: "bold" }}>
            OBJECTIVE
          </h1>
          <hr />
